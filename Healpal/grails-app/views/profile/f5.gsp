...
<div class="profile-wrapper">
	<img src="../assets/profile/img/f5.jpg" alt="image" align="middle">
				...
				<div class="row">
					<div class="col-md-10 col-xs-12 center-align text-center">
						<div class="profile-black-pad">
							<h1>You are 50% done!</h1>
							<p class="pad-bot-0">You are halfway there</p>
							<p>keep at it!</p>
							<div class="white-bor-box">
								<div class="pink-box col-sm-6 col-xs-7 pad-lt-0">
									<div>50%</div>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="clearfix mar-top-10"></div>
							<div class="col-sm-5 m-pad-lr" style="text-decoration: none;"><g:link controller="patientMatch"
									action="patientMatch" class="orange-view-btn" >View Your Matches</g:link></div>
							<div class="col-sm-7 m-pad-lr"><g:link controller="profile" action="g1" class="blue-btn">Continue Completing Your Profile</g:link></div>
							<div class="clearfix mar-bot-10"></div>
							<p>Next up -More treatment details</p>
						</div>
					</div>
				</div>
			</div>
