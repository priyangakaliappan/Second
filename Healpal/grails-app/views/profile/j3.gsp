...
<div class="profile-wrapper">
	<img src="../assets/profile/img/j3.jpg" alt="image" align="middle">
				...
				<div class="row">
					<div class="col-md-10 col-xs-12 center-align text-center">
						<div class="profile-black-pad">
							<h1>We admire your commitment.</h1>
							<p class="pad-bot-0">Your profile is
											getting stronger with each step.<br />It determines  how close a
													match we can find for you.</p>
													<div class="clearfix mar-bot-50"></div>
							<div class="white-bor-box">
								<div class="pink-box col-sm-10 col-xs-7 pad-lt-0">
									<div>80%</div>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="clearfix mar-top-10"></div>
							<div class="col-sm-5 m-pad-lr"><g:link controller="patientMatch"
									action="patientMatch" class="orange-view-btn">View Your Matches</g:link></div>
							<div class="col-sm-7 m-pad-lr"><g:link controller="profile" action="k1" class="blue-btn">Continue Completing Your Profile</g:link></div>
							<div class="clearfix mar-bot-10"></div>
							<p>Next Up - tell us about the side effects of your
											treatment.</p>
						</div>
					</div>
				</div>
