...
<div class="profile-wrapper">
	<img src="../assets/profile/img/ca13.jpg" alt="image" align="middle">
				...
				<div class="row">
					<div class="col-md-10 col-xs-12 center-align text-center">
						<div class="profile-black-pad">
							<h1>You are 20% done!</h1>
							<p>And you are tackling these questions efficiently.</p>
							<div class="white-bor-box">
								<div class="pink-box col-sm-2 col-xs-4 pad-lt-0">
									<div>20%</div>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="clearfix mar-top-10"></div>
							<div class="col-sm-5 pad-lr-0"><g:link controller="patientMatch" action="patientMatch" class="orange-view-btn">View Your Matches</g:link></div>
							<div class="col-sm-7 pad-lr-0"><g:link class="blue-btn" controller="profile" action="d1">Continue Completing Your Profile</g:link></div>
							<div class="clearfix mar-bot-10"></div>
							<p>Next up  -Tell us about your diagnosis</p>
						</div>
					</div>
				</div>
			</div>
