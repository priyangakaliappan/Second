				...
				<div class="row">
					<div class="col-md-10 col-xs-12 center-align text-center">
						<div class="profile-black-pad">
							<h1>Hi, <g:if test="${currentPersonName}">
										${currentPersonName}.
									</g:if> Nice to meet you.</h1>
							<p>Please create your profile. Connect with a member <br />of the HealPal community who is the closest match to you.</p>
							<div class="clearfix mar-top-10"></div>
							<g:link class="blue-btn" controller="profile" action="a1">Continue</g:link>					</div>
					</div>
				</div>
			</div>
		</section>
