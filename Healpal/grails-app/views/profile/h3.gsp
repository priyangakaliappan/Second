...
<div class="profile-wrapper">
	<img src="../assets/profile/img/h3.jpg" alt="image" align="middle">
				...
				<div class="row">
					<div class="col-md-10 col-xs-12 center-align text-center">
						<div class="profile-black-pad">
							<h1 class="pad-bot-0">You are 70% done!</h1>
							<p class="pad-bot-0">And now you're in the home stretch.</p>
							<div class="clearfix mar-bot-50"></div>
							<div class="white-bor-box">
								<div class="pink-box col-sm-9 col-xs-7 pad-lt-0">
									<div>70%</div>
								</div>
							...
							<div class="col-sm-7 m-pad-lr"><g:link controller="profile" action="i1" class="blue-btn">Continue Completing Your Profile</g:link></div>
