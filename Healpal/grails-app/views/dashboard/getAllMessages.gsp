...
<title>::.. Healpal | All Messages ..::</title>
</head>
<body>
				...
				<div class="col-sm-12 col-xs-12">
					<div class="box-content6">
						<div class="col-sm-3 col-xs-12 dashboard-sidebar-left">
							...
							<div class="dark-graybox1">
								...
								<div class="text-center">
									...
									<g:link controller="patientMatch" action="patientMatch"
										class="view-profile-btn">Invite Friends</g:link>
								</div>
							</div>
						...
						<div class="col-sm-9 col-xs-12 dashboard-sidebar-right"
							id="messages">
							<g:render template="allMessageList"></g:render>
						</div>
					</div>
				</div>
			</div>
