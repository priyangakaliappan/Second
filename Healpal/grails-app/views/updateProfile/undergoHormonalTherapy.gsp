...
<div class="col-sm-12">
			...
			<g:link controller="updateProfile" action="undergoHormonalTherapy"
				params="[question:'Did You Undergo Hormonal therapy',ans:'No']"><h3><span>No</span></h3></g:link></div>
								</div>
								<div class="box-content2">
									<g:if test="${value == 'Scheduled for Hormonal therapy'}">
		...
		<g:link controller="updateProfile" action="undergoHormonalTherapy"
			params="[question:'Did You Undergo Hormonal therapy',ans:'Scheduled for Hormonal therapy']"><h3><span>Scheduled for Hormonal therapy</span></h3></g:link></div>
								</div>
							</div>
							</div>
						</div>
...
<script>
		...
		$(document).on('click','.answer_link',function(){
			if($(this).attr('id') != ""){
					var url="../UpdateProfile/hormoneTherapyDrugs?answer="+$(this).attr('id');
