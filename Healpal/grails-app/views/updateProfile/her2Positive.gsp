...
<div class="col-sm-12">
					...
					<g:else>
						...
						params="[type:'HER',value:'Yes']"><h3><span>Yes</span></h3></g:link></div>
								</div>
								<div class="box-content2">
									<g:if test="${value == 'No'}">
				...
				<g:else>
					...
					params="[type:'HER',value:'No']"><h3><span>No</span></h3></g:link></div>
								</div>
								<div class="box-content2">
			...
			<g:else>
				...
				params="[type:'HER',value:'Dont Know']"><h3><span>Don't know</span></h3></g:link></div>
								</div>
							</div>
							</div>
						</div>
