...
<div class="col-sm-12">
				...
				<g:link controller="updateProfile" action="updatePositive"
					params="[type:'PR',value:'Yes']"><h3><span>Yes</span></h3></g:link></div>
								</div>
								<div class="box-content2">
									<g:if test="${value == 'No'}">
			...
			<g:link controller="updateProfile" action="updatePositive"
				params="[type:'PR',value:'No']"><h3><span>No</span></h3></g:link></div>
								</div>
								<div class="box-content2">
		...
		<g:link controller="updateProfile" action="updatePositive"
			params="[type:'PR',value:'Dont Know'];"><h3><span>Don't know</span></h3></g:link></div>
								</div>
							</div>
							</div>
						</div>
