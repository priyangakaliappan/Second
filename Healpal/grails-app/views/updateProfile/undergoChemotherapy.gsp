...
<div class="col-sm-12">
			...
			<g:link controller="updateProfile" action="undergoChemotherapy"
				params="[question:'Did you undergo Chemotherapy?',ans:'No']"><h3><span>No</span></h3></g:link></div>
								</div>
								<div class="box-content2">
									<g:if test="${value == "Scheduled for Chemo-therapy"}">
		...
		<g:link controller="updateProfile" action="undergoChemotherapy"
			params="[question:'Did you undergo Chemotherapy?',ans:'Scheduled for Chemo-therapy']"><h3><span>Scheduled for Chemo-therapy</span></h3></g:link></div>
								</div>
							</div>
							</div>
						</div>
...
<script>
	...
	$(document).on(
			...
			function() {
				if ($(this).attr('id') != "") {
					var url = "../UpdateProfile/chemotherapyDrugs?answer="
							+ $(this).attr('id');
