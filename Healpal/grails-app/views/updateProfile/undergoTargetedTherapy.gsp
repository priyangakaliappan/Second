...
<div class="col-sm-12">
			...
			<g:link controller="updateProfile" action="undergoTargetedTherapy"
				params="[question:'Did You Undergo targeted therapy',answer:'No']"><h3><span>No</span></h3></g:link></div>
								</div>
								<div class="box-content2">
									<g:if test="${value =='Scheduled for targeted therapy'}">
...
<script>
	...
	$(document).on(
			...
			function() {
				if ($(this).attr('id') != "") {
					var url = "../UpdateProfile/targetedTherapies?answer="
							+ $(this).attr('id');
