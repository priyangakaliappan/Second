 ...
 * Project 		: Healpal
 * Date    		: 10/10/2015
 * Description	:surgicalProcedureView
 *
...
<body>
	<div id="tables_page" class="main_container glass admin-content">		
			<div class="row-fluid title orange-topstripe">
				...
				<div class="pull-right">small><g:link controller="dashboard" action="adminDashboard">Home </g:link><i class="icon-angle-double-right"></i> Surgical Procedure</small></div>
			</div>
			<div class="row-fluid">
				<div class="widget span12 box">
					...
					<div class="control-group">
						<div class="controls">
							<g:link controller="SurgicalProcedure" action="create" class="btn btn-info btn-medium table-btn">Add New</g:link>
						</div></div>
						<div class="col-xs-6">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								...
								<h6 class="red-text">
									...
									<g:render template="viewSurgical"></g:render>
							</div>
						</div>
					</div>
				</div>
