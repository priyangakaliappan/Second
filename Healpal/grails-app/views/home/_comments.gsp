				...
				<div class="col-lg-11 col-md-11 col-sm-11 pad-rt-0">
					<div class="single-right-content">
						...
						--%><div class="orange-text">
							...
							<g:formatDate date="${list?.rowCreated}" style="short" type="date" />
						</div>
						<p>
							${list.comments}
						</p>
...
<g:if test="${commentsTotal > offset && commentsMax < commentsTotal}">
	<g:remoteLink controller="home" action="comments"
		...
		params="['comment_size':commentsTotal,'comment_maxSize':commentsMax,'commentPatient':reviewId,viewMore:'true']">View More<i
			class="view-more-icon"></i>
	</g:remoteLink>
</g:if>
<%--<a class="read-view-text orange-text" href="#">View More<i class="view-more-icon"></i></a>**************${commentPatient}--%>