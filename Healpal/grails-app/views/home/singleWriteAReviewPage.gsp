...
<body>
		...
		<section class="inner-white-bg">
			<div class="container container-1330">
				<div class="row">
					...
					def photoName = homeController?.getPhotoNameForSingleReviewPage(singleReviewId);
					 %>
 ...
 '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;">
                       ...
                       '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i
									...
									href="https://twitter.com/home?status=https://127.0.0.1${request.forwardURI + '?' + request.queryString}"
									onclick="javascript:window.open(this.href,
                       '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;">
							...
							<textarea placeholder="Add a comment..." id="userComments"
								...
								<g:else>
								<textarea placeholder="Add a comment..." class="signin-text check-layout" id="showPopUp"
								name="userComments"></textarea>
</g:else>
					...
					def photoName = patientMatchController?.getPhotoNameForFindReview(list?.commentedPatient?.person?.id);
					 %>
						...
						<div
							...
							<h3 class="right-sidebar-content">Related Reviews</h3>
	...
	${params.singleReviewId}
		//alert($("#userComments").val());
					...
					e.preventDefault();
						...
						$("#cmd_warn").html("Please enter your comments")
						return false;
						}
				}
			});
