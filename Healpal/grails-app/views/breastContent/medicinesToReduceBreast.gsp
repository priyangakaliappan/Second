...
<section class="inner-cont">
		<div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 inner-left-cont left-gray-bg">
			...
			<div class="left-gray-box-cont">
				<div class="next-section">
					<div class="col-sm-9 col-xs-9 pad-lt-0">
						<h2> NEXT SECTION:  </h2>
						<p> CLINICAL TRIALS </p>
					</div>
					<div class="col-sm-3 col-xs-3">
						<g:link action="ammericanCancerSocietyRecommendationFor" controller="breastContent" class="round"><i class="fa fa-chevron-right"></i></g:link>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>	
			<div class="left-icons2 mar-top-0">
				<ul>
					<li> <g:link action="aboutTheBreastCancer" controller="breastCancer" title="About"><i class="breast-2"></i></g:link></li>
						<li> <g:link action="diagnosis" controller="breastCancer" title="Diagnosis"> <!--<img src="../assets/images-breast/breast-3.png" class="img-responsive">--><i class="breast-3"></i></g:link></li>
						<li> <g:link action="treatmentOptions" controller="breastCancer" title="Treatment Options"> <!--<img src="../assets/images-breast/breast-4.png" class="img-responsive"--><i class="breast-4"></i></g:link></li>
						<li class="active"> <g:link action="preventioEarlyDetection" controller="breastCancer" title="Prevention and Early Detection"> <!--<img src="../assets/images-breast/breast-5.png" class="img-responsive"--><i class="breast-5"></i></g:link></li>
						<li> <g:link action="clinicalTrial" controller="breastCancer" title="Clinical Trials"> <!--<img src="../assets/images-breast/breast-6.png" class="img-responsive">--><i class="breast-6"></i></g:link></li>
						<li> <g:link action="copingLifeStyle" controller="breastCancer" title="Coping Lifestyle"> <!--<img src="../assets/images-breast/breast-7.png" class="img-responsive">--><i class="breast-7"></i></g:link></li>
				</ul>
			</div>
		</div>
		<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12 inner-right-cont right-gray-cont">
			<h2> MEDICINES TO REDUCE BREAST CANCER RISK </h2>
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<img src="../assets/images-breast/text-img1.jpg" class="img-responsive"></a>
					<div class="text-center download-text">
						<p><a href="#" data-toggle="modal" data-target="#myModal3">Click to Enlarge</a></p>
					</div>
				</div>
				<div class="col-sm-8 col-xs-12">
					<p> exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit   </p>
					<ul class="media-box">
						<li>
							<div class="col-md-3 col-sm-4 col-xs-4 pad-lt-0"><a href="#"><img src="../assets/images-breast/video-thumb.jpg" class="img-responsive"></a></div>
							<div class="col-md-8 col-sm-6 col-xs-6 pad-lt-0">
								<h4>2015 Breast Cancer Incidence</h4>
								<p>BreastCance rDeadline2020 </p>
							</div>
							<div class="col-md-1 col-sm-2 col-xs-2 pad-lr-0"><p class="time-text">2:30</p></div>
							<div class="clearfix"></div>
						</li>
						<li>
							<div class="col-md-3 col-sm-4 col-xs-4 pad-lt-0"><a href="#"><img src="../assets/images-breast/video-thumb.jpg" class="img-responsive"></a></div>
					...
					<div class="comments-box">
						<div class="col-md-1 col-sm-2 col-xs-2 pad-lt-0"><img src="../assets/images-breast/healpal.png"></div>
						<div class="col-md-11 col-sm-10 col-xs-10"><input type="text" placeholder="Post a comment or ask a question" class="form-control"></div>
						<div class="clearfix"></div>
					</div>
					<div class="pull-left">
					...
					<div class="comment-cont">
						<h5>mac1985<small> jan, 05 2015 at 01:05PM </small></h5>
