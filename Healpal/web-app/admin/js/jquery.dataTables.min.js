				...
				l.defaults = {
					...
					oLanguage : {
						...
						oPaginate : {
							sFirst : "First",
							sLast : "Last",
							sNext : messages.admin.paginate.next(),
							sPrevious : messages.admin.paginate.prev()
						},
						sEmptyTable : messages.patientportal.gsp.label.nodata(),
						sInfo : messages.patientportal.gsp.label.showing()
								+ " _START_ "
								+ messages.patientportal.gsp.label.to()
								+ " _END_ "
								+ messages.patientportal.gsp.label.of()
								+ " _TOTAL_ "
								+ messages.patientportal.gsp.label.entries(),
						sInfoEmpty : messages.patientportal.gsp.label.noentries(),
						...
						sSearch : messages.patientportal.gsp.label.search(),
						sUrl : "",
